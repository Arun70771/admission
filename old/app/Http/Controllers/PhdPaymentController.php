...
class PhdPaymentController extends Controller
{
    ...
    public function generatePaymentUrl()
    {
        ...
        $admission     =   Admission::find($userId);


        if ($admission->Phd_programmes == 'Mathematics' || $admission->Phd_programmes == 'Biotechnology' || $admission->Phd_programmes == 'Computer Science') {
            $transactionAmount = 99600;
        }else {
            $transactionAmount = 83000;
        }
        ...
        $submerchantId = 45;
        $returnUrl = 'https://admissions.sau.ac.in/index.php/phd_payment/success'; // Your success URL
    ...
    public function paymentResponse(Request $request)
    {
        ...
        if ($Response_Code == 'E000') {
            ...
            return redirect('phd_application_fee')->with('success', 'Your Payment has been successfully completed');
        } else {
            ...
            return redirect('phd_application_fee')->with('warning', 'Please complete payment process for registration');
        }
    }
}