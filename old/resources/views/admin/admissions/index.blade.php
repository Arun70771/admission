                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($value->programme == 'Masters')
                                                            ( Online MS Programmes in Data Science and Artificial
                                                            Intelligence )
                                                        @elseif($value->programme == 'PhD')
                                                            ( {{ $value->Phd_programmes }} )
                                                        @elseif($value->programme == 'short_term')
                                                            ( Short-Term Courses )
                                                        @endif
                                                    ...
                                                    <td>
                                                        <a
                                                            href="http://admissions.sau.ac.in/index.php/generate-pdf/{{ $value->id }}">Certificaes</a>
                                                        <br>
                                                    ...
                                                    <td> <a class="btn btn-danger"
                                                            ...
                                                            href='{{ url("admin/Admissions/del/$value->id") }}'
