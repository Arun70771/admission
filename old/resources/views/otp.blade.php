                        ...
                        <div class="hero-form" data-aos-delay="900" data-aos="fade-up">
                            <div class="hero-form-wrap">
                                <div class="heading-wrap text-center">
                                    ...
                                    <p>
                                        <b style="display: block; color: #183e65;font-size: 16px;font-weight: 500;padding-top: 20px;">OTP</b>
                                    </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="single-form">
                                                <input type="hidden" value="{{Request::segment(2)}}" name="userId">
                                                <input type="text" id="txtPassword" name="otp" placeholder="Enter OTP" value="{{ old('otp') }}">
                                            </div>
                                            <!-- Single Form End -->
                                        </div>
                                        <div class="col-sm-12">
